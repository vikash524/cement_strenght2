...
def main():
    ...
    if st.button("About Author"):
               st.image("D:\cement_strenght2\cement_strenght2\Concrete-Compressive-Strength-Prediction\805c2710-18f3-448c-add6-cbe9d6ac617d.jpg", width=100)  # Replace with your image path
               st.text("Name : vikash chauhan") 
               st.text("Email : vikashchauhanvv26@gmail.com") 
